...
public class RemoveUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        otherNameTxt.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
    ...
    private void removeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeBtnActionPerformed
        ...
        if (idTxt.getText().equals("") || firstNameTxt.getText().equals("")
                 || otherNameTxt.getText().equals("") || userNameTxt.getText().equals("")) {
            ...
            System.out.print("About to Delete the values.!!!");  
            
            try {
                    connectDB.setAutoCommit(false);
                    
                    java.sql.PreparedStatement pstmt = connectDB.prepareStatement("DELETE FROM secure_access_tbl WHERE id = '"+idTxt.getText()+"'");
                        ...
                        JOptionPane.showMessageDialog(null, "User has been removed successfully. ", 
                            "Success!!! User removed successfully", JOptionPane.INFORMATION_MESSAGE);
