...
public class JTable extends org.jdesktop.swing.JXTable implements java.lang.Runnable {//javax.swing.JTable {
    ...
    com.amimobenja.www.helpers.XMLExport xmlExport;
    com.amimobenja.www.helpers.ExcelExport excelExport;
    com.amimobenja.www.helpers.HTMLExport htmlExport;
    com.amimobenja.www.helpers.PDFExport pdfExport;
    ...
    public JTable() {        
        ...
        tableName = sdf.format(today)+" Doc";
    }
    ...
    public void run() {
        ...
        while (exportTableBoolean) {
            ...
            if (Thread.currentThread().getName().matches("Export2Excel")) {
                ...
                excelExport = new com.amimobenja.www.helpers.ExcelExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2Xml")) {

                xmlExport = new com.amimobenja.www.helpers.XMLExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2HTML")) {

                htmlExport = new com.amimobenja.www.helpers.HTMLExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2PDF")) {

                pdfExport = new com.amimobenja.www.helpers.PDFExport(this.getExportTable(), tableName);
...
//                tableColorHeader = java.lang.Integer.parseInt(System.getProperty("tableColorHeader"));
                tableColorA = java.lang.Integer.parseInt("-3342388");
                tableColorB = java.lang.Integer.parseInt("-3355393");
                //System.out.println("Database Server IP : "+dbServerIp);
                tableColorHeader = java.lang.Integer.parseInt("-16711681");

                
                System.out.println("TableColorA - "+tableColorA+"\nTableColorB - "+tableColorB+"\nTableColorHeader - "+tableColorHeader);
...
//        for (int i = 0; i < patterHighlighterArray.length; i++) {
//            highlighters = new org.jdesktop.swing.decorator.Highlighter[]{
//                new org.jdesktop.swing.decorator.AlternateRowHighlighter(colorA, colorB, null),
//                patterHighlighterArray[i],
//                new org.jdesktop.swing.decorator.HierarchicalColumnHighlighter()
//            };
//        }
