...
public class JTable extends org.jdesktop.swing.JXTable implements java.lang.Runnable {//javax.swing.JTable {
    ...
    com.amimobenja.www.XMLExport xmlExport;
    com.amimobenja.www.ExcelExport excelExport;
    com.amimobenja.www.HTMLExport htmlExport;
    com.amimobenja.www.PDFExport pdfExport;
    ...
    public void run() {
        ...
        while (exportTableBoolean) {
            ...
            if (Thread.currentThread().getName().matches("Export2Excel")) {
                ...
                excelExport = new com.amimobenja.www.ExcelExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2Xml")) {

                xmlExport = new com.amimobenja.www.XMLExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2HTML")) {

                htmlExport = new com.amimobenja.www.HTMLExport(this.getExportTable(), tableName);

            } else if (Thread.currentThread().getName().matches("Export2PDF")) {

                pdfExport = new com.amimobenja.www.PDFExport(this.getExportTable(), tableName);
