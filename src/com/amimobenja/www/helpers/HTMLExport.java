...
//            tempXMLDocFile = java.io.File.createTempFile("tempExportXMLLDoc", ".xml", new java.io.File(System.getProperty("docsdir")));
            tempXMLDocFile = new java.io.File(System.getProperty("docsdir"),exportTableName+".xml" );
            
//            htmlDocFile = java.io.File.createTempFile("ExportHTMLDoc", ".html", new java.io.File(System.getProperty("docsdir")));
            htmlDocFile = new java.io.File(System.getProperty("docsdir"),exportTableName+".html" );
...
//            refDocString = "";
        ...
        com.amimobenja.www.helpers.XmlSerializer xmlSerializer = new com.amimobenja.www.helpers.XmlSerializer(tableName2Export, xmlOutputStream, refDocString, exportTableName);
